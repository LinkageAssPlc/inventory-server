...
POST("/sign-up", [
  baseValidation(AuthValidation.signUp),
  AuthController.signUp,
]);
POST("/sign-in", [
  baseValidation(AuthValidation.signIn),
  AuthController.signIn,
]);
POST("/send-otp", [
  baseValidation(AuthValidation.sendOTP),
  AuthController.sendOTP,
]);
POST("/verify-otp", [
  baseValidation(AuthValidation.verifyOTP),
...
POST("/forgot-password", [
  baseValidation(AuthValidation.forgotPassword),
